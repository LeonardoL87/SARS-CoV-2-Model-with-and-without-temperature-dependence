...
for i in np.arange(Iter):
    ...
    sol = minimize(residual, params, args=(topt,DataM),method='least_squares',max_nfev=100000,
                        ftol=1e-8,gtol=1e-8,xtol=1e-8,loss='arctan',diff_step=1e-4,verbose=2,tr_solver='lsmr')
    paropt=sol.params
