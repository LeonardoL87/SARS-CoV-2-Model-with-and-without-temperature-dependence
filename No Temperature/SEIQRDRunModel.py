...
#    vec2=np.zeros(len(ti))
#    Yinterp={'t':t,'S':vec2,'E':vec2,'A':vec2,'I':vec2,'R':vec2,'D':vec2,'P':vec2,'Y':vec2}
    Yinterp={}
    Yinterp['t']=ti
    for i in datcol:
#        print(Y[str(i)])
...
# Here you can set the location you want to run
...
# Here you upload the data you need to run the model for a particular location
# You need to uncomment the 'File'  variable 

Dir='Parameters/No Temperature/'
# File='Barcelona1.pckl'
# File='Barcelona2.pckl'
# File='Barcelona3.pckl'

# File='Catalunya1.pckl'
# File='Catalunya2.pckl'
# File='Catalunya3.pckl'

# File='Lombardia1.pckl'
# File='Lombardia2.pckl'

# File='Thuringen1.pckl'
File='Thuringen2.pckl'



Name=Dir+File

ini,time,Active,Confirmed,Recovered,Deaths,Active,T,timeT,FullSetOptParam=pickle.load(open(Name,"rb"))
